...
export default function CountrySelect({ value, onChange, className = '' }: CountrySelectProps) {
  return (
    <select
      ...
      className={`w-full bg-transparent border-0 border-b-2 border-red-600 text-white focus:outline-none focus:border-red-500 py-2 appearance-none text-base sm:text-xl font-cyberpunk ${className}`}
    >
